...
func init() {
	...
	//rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.amqp-sb-client.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".amqp-sb-client" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".amqp-sb-client")
	}
